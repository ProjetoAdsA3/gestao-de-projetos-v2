...
INSERT INTO `projects` VALUES (1,'Projeto Faculdade','criação para dia a dia com sql e java','2025-08-30 00:00:00','2025-08-30 00:00:00');
...
-- Dump completed on 2025-09-01 21:22:27
-- MySQL dump 10.13  Distrib 8.0.28, for macos11 (x86_64)
--
...
CREATE TABLE `projeto_equipe` (
  ...
  CONSTRAINT `projeto_equipe_ibfk_2` FOREIGN KEY (`equipe_id`) REFERENCES `equipes` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-08-30 00:49:59',NULL),('diagnostics.include_raw','OFF','2025-08-30 00:49:59',NULL),('ps_thread_trx_info.max_length','65535','2025-08-30 00:49:59',NULL),('statement_performance_analyzer.limit','100','2025-08-30 00:49:59',NULL),('statement_performance_analyzer.view',NULL,'2025-08-30 00:49:59',NULL),('statement_truncate_len','64','2025-08-30 00:49:59',NULL);
...
-- Dump completed on 2025-09-01 21:22:28
-- MySQL dump 10.13  Distrib 8.0.28, for macos11 (x86_64)
--
-- Host: 127.0.0.1    Database: gestao_de_projetos
-- ------------------------------------------------------
-- Server version	8.0.28
...
-- Dump completed on 2025-09-01 21:22:29
